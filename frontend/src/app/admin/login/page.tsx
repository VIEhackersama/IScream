...
function validate(data: FormData): FormErrors {
    ...
    if (!data.usernameOrEmail.trim()) errors.usernameOrEmail = "Please enter your username or email.";
...
export default function AdminLoginPage() {
    ...
    const [form, setForm] = useState<FormData>({ usernameOrEmail: "", password: "" });
                ...
                <div className="relative hidden w-[45%] flex-col justify-between overflow-hidden md:flex">
                    ...
                    <div className="relative z-10 flex flex-col items-center gap-3 pt-12">
                        <div className="flex size-[64px] items-center justify-center rounded-2xl bg-white/20 shadow-lg backdrop-blur-sm ring-1 ring-white/30">
                            <MaterialIcon name="icecream" filled className="text-[36px] text-white" />
                        </div>
                        <div className="flex flex-col items-center gap-1 text-center">
                            <h2 className="text-2xl font-black tracking-tight text-white drop-shadow">Mr. A</h2>
                    ...
                    <div className="relative z-10 m-6">
                        <div className="rounded-2xl bg-black/50 p-4 backdrop-blur-md ring-1 ring-white/10">
                            <div className="mb-2 flex items-center gap-2">
                                <MaterialIcon name="campaign" filled className="text-[16px] text-primary" />
                                <span className="text-[10px] font-bold uppercase tracking-widest text-white/60">
                                    Latest Update
                                </span>
                            </div>
                            <p className="text-xs leading-relaxed text-white/90">
                                &ldquo;The Vanilla Chronicles&rdquo; recipe book is now live for subscribers.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-1 flex-col justify-between bg-white px-8 py-10 md:px-10">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="flex items-center gap-2">
                            <MaterialIcon name="admin_panel_settings" filled className="text-[18px] text-primary" />
                        ...
                        {errors.general && (
                            <div className="flex items-start gap-2 rounded-xl bg-red-50 px-4 py-3 text-sm font-medium text-red-600">
                                <MaterialIcon name="error" filled className="mt-px shrink-0 text-[18px] text-red-500" />
                                {errors.general}
                            </div>
                        )}
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-5" noValidate>
                            ...
                            {/* Username or Email */}
                            <div className="flex flex-col gap-1.5">
                                <label htmlFor="admin-username" className="text-sm font-semibold text-text-main">
                                    Username or Email
                                </label>
                            ...
                            <div className="flex flex-col gap-1.5">
                                <div className="flex items-center justify-between">
                                    <label htmlFor="admin-password" className="text-sm font-semibold text-text-main">
                                        Password
                                    </label>
                                    <a
                                        href="#"
                    ...
                    <div className="mt-8 flex flex-col gap-4 border-t border-gray-100 pt-6">
                        ...
                        <p className="text-center text-[11px] text-gray-400">
                            © 2025 Mr. A Ice Cream Parlor. All rights reserved.
                        </p>
                    </div>
                </div>
