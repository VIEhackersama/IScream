...
export function Footer() {
  return (
    <footer className="w-full pt-10 border-t border-gray-200 dark:border-white/5">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
        ...
        <div className="col-span-2 md:col-span-1">
          <Link href={routes.home} className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-text-main dark:text-white font-extrabold">
        ...
        {footerSections.map((section) => (
          <div key={section.title} className="flex flex-col gap-3">
            <h4 className="font-bold text-text-main dark:text-white text-sm uppercase tracking-wider mb-1">
              {section.title}
            </h4>
            {section.links.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="text-text-muted dark:text-gray-400 text-sm hover:text-primary dark:hover:text-primary transition-colors"
              >
                {link.label}
              </Link>
            ))}
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex gap-4">
            <a
              ...
              className="size-10 rounded-full bg-gray-100 dark:bg-white/5 flex items-center justify-center text-text-main dark:text-white hover:bg-primary hover:text-white transition-colors"
              aria-label="Twitter"
            >
              <svg
      ...
      {/* Bottom bar */}
      <div className="flex flex-col md:flex-row justify-between items-center border-t border-gray-200 dark:border-white/5 pt-8 pb-6">
